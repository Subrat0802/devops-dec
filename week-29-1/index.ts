...
//     const ec2Response = await ec2Client.send(ec2InstanceCommand);
//     console.log("ec2Response", ec2Response.Reservations[0]?.Instances[0].PublicDnsName);
// };
...
//     const idleMachien = ALL_MACHINES.find((x: { isUsed: boolean; }) => x.isUsed === false);
//     if(!idleMachien) {
//         res.status(400).json({
//             message:"No idle machine present"   //if machine is not available scale up here
//         })
//         return;
//     }
//     idleMachien.isUsed = true;
